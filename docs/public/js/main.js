...
var Main = function() {
	...
	window.document.addEventListener("DOMContentLoaded",function(event) {
		$global.console.log("Dom ready :: build: " + "2020-10-30 12:56:06" + " ");
...
Template.createVue = function() {
	...
	var html1 = template_TVue.transition({ "name" : "custom-classes-transition", "enter-active-class" : "animated fadeIn", "leave-active-class" : "animated fadeOut"},[html3]);
	var html2 = template_Html.h5({ _class : "card-title", text : "{{ item.title }}"});
	var html3 = template_Html.p({ _class : "card-text", text : "{{ item.body }}"});
	var html4 = template_Html.a({ href : "#", _class : "btn btn-primary", text : "read more"});
	var html5 = template_Html.div({ _class : "card-body"},[html2,html3,html4]);
	var html2 = template_Html.div({ _class : "card"},[html5]);
	var html3 = template_Html.div({ _class : "col-sm-12 col-md-6 col-lg-4", "v-for" : "item in sheet"},[html2]);
	var html2 = template_Html.div({ _class : "row"},[html3]);
	var html3 = template_TVue.vue([template_Html.div({ id : "app"},[html,html1,html2])]);
